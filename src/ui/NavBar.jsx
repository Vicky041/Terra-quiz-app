                ...
                <NavBarComp>
                    <Nav>
                        ...
                        <NavButtons className="nav--buttons">
                            <Button type="button" color="#fff" bgColor="transparent">Login</Button>
                            <Button type="button" color="#442d7c" bgColor="#fff">Take A Quiz</Button>
                        </NavButtons>
                        <Hamburger className="hamburger" isClicked={isMenuOpen} onSetIsClicked={setIsMenuOpen}/>
                    </Nav>
                </NavBarComp>
            </Header>
            {isMenuOpen && <DropDown />}
        ...
        <div className="dropdown">
            <>
                ...
                <NavButtons className="dd__nav--buttons">
                    <Button type="button" color="#442d7c" bgColor="transparent">Login</Button>
                    <Button type="button" color="#fff" bgColor="#442d7c">Take A Quiz</Button>
                </NavButtons>
            </>
        </div>
    )
...
function NavLinks({className}) {
  ...
  return (
    <nav className={className}>
      <ul>
        {navItems.map((item, i) => (
          <li key={i}><a href={item.to}>{item.label}</a></li>
        ))}
      </ul>
    </nav>
  );
